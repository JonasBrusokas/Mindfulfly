...
document.addEventListener("click", (e) => {
  ...
  const CLICKED_PROP_NAME = "clicked"

  if (e.target.id === "update-info") {
    ...
    //   let storageObject = browser.storage.local.get()
    //   if (!storageObject[CLICKED_PROP_NAME]) {
    //     storageObject[CLICKED_PROP_NAME] = 0;
    //   }
    //   storageObject[CLICKED_PROP_NAME] += 1
